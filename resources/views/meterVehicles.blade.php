            ...
            <div class="card mb-5 mb-xl-8">
                ...
                <div class="card-header border-0 pt-5">
                    ...
                    <div class="card-toolbar">
                        <a href="/meter/meterAdd" class="btn btn-sm btn-light-primary">
                            ...
                            <tbody>
                                @if($vehicles && $vehicles->count()>0)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @php
                                                if ($vehicle->meter_entries_max_meter_entry){
                                                    ...
                                                    $entryClass = "";
                                                    $totalRun = $maxEntry - ($vehicle->meter_start)." Km";
                                                }else{
                                                    $totalRun = "No Data";
                                        ...
                                        <td class="text-end">
                                            <a href="/meter/meterEntryAdd/{{ $vehicle->id }}" class=" btn btn-primary p-2">
                                                +Entry
                                            </a>
                                            {{-- <a href="/requisition/send/{{ $vehicle->id }}" class=" btn btn-primary p-2">
                                                Records
                                            </a> --}}
                                            <a href="/meter/vehicleMeterEntries/{{ $vehicle->id }}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
