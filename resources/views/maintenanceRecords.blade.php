            ...
            <div class="card mb-5 mb-xl-8">
                ...
                <div class="card-header border-0 pt-5">
                    ...
                    <div class="card-toolbar">
                        <?php
                            $formAction = '/maintenance/maintenanceRecords/filter';
                            $refreshAction = '/maintenance/maintenanceRecords';
                        ?>
                            ...
                            <tbody>
                                @if($maintenanceRecords && $maintenanceRecords->count()>0)
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            <a href="/maintenance/edit/{{ $entry->id }}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                            ...
                                            <a href="#" data-bs-toggle="modal" data-bs-target="#delete_Modal" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm cd_modal" data-item="/maintenance/delete/{{ $entry->id }}" >
