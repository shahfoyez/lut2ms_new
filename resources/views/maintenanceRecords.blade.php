                            ...
                            <tbody>
                                @if($maintenanceRecords && $maintenanceRecords->count()>0)
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            <a href="/fuel/editFuelRecord/{{ $entry->id }}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                            ...
                                            <a href="/fuel/fuelDelete/{{ $entry->id }}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm">
