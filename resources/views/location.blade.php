									...
									<div class="menu-sub menu-sub-accordion menu-active-bg">
										...
										<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
											...
											<div class="menu-sub menu-sub-accordion menu-active-bg">
												...
												<div class="menu-item">
													<a class="menu-link active" href="../../demo8/dist/modals/search/select-location.html">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
						...
						<div class="toolbar">
							...
							<div class="container-fluid py-6 py-lg-0 d-flex flex-column flex-lg-row align-items-lg-stretch justify-content-lg-between">
								...
								<div class="page-title d-flex flex-column me-5">
									<!--begin::Title-->
									<h1 class="d-flex flex-column text-dark fw-bolder fs-3 mb-0">Select Location</h1>
									<!--end::Title-->
									<!--begin::Breadcrumb-->
								...
								<div class="card">
									...
									<div class="card-body pb-0">
										...
										<div class="card-px text-center pt-20 pb-5">
											<!--begin::Title-->
											<h2 class="fs-2x fw-bolder mb-0">Select Location Modal Example</h2>
											<!--end::Title-->
											<!--begin::Description-->
