            ...
            <div class="card mb-5 mb-xl-8">
                ...
                <div class="card-header border-0 pt-5">
                    ...
                    <div class="card-toolbar">
                        <?php
                            $formAction = '/maintenance/maintenanceVehicles/filter';
                            $refreshAction = '/maintenance/maintenanceVehicles';
                        ?>
                            ...
                            <tbody>
                                @if($vehicles && $vehicles->count()>0)
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            <a href="/maintenance/maintenanceAdd/{{ $vehicle->id }}" class=" btn btn-primary p-2">
                                                +Entry
                                            </a>
